...
namespace WPF.CustomControl
{
    ...
    public class GridLineDecorator : FrameworkElement
    {
        ...
        private bool _IsVisibleLineBrush = false;//是否可见边框
        ...
        #region GridLineVisibility
        public static readonly DependencyProperty GridLineVisibilityProperty =
            DependencyProperty.Register("GridLineVisibility", typeof(Visibility), typeof(GridLineDecorator),
            new FrameworkPropertyMetadata(Visibility.Collapsed, new PropertyChangedCallback(OnGridLineVisibilityChanged)));
        ...
        {
            ((GridLineDecorator)d).OnGridLineVisibilityChanged(e);
        }

        private void OnGridLineVisibilityChanged(DependencyPropertyChangedEventArgs e)
        {
            if (this.GridLineVisibility == Visibility.Visible)
                _IsVisibleLineBrush = true;
        }
        #endregion
        ...
        /// indicates ....
        /// 获取或设置的GridLineBrush属性。这种依赖关系属性表示....
        /// </summary>
