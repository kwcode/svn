    ...
    <div class="d-content">
        ...
        <div style="padding: 10px; text-align: center;">
            <%
                ...
                {
            %>
            <img id="img-adres" data-type="1" style="max-height: 800px; max-width: 1100px;" src="<%=DtProductdesc.Rows[0]["ImgUrl"] %>" onerror="this.onerror=null;this.src='/images/nophoto1.jpg'" alt="昱晶科技发展有限公司" title="昱晶科技发展有限公司" />
            <div></div>
            <%
                }
                else
