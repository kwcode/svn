<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m_NvaBarManager.aspx.cs" Inherits="admin_m_NvaBarManager" %>
    ...
    <script>
        $(function () {
                ...
                handler: function () {
                    ...
                    var _layerIndex = $.layer({
                        ...
                        success: function ($layer) {
                            $layer.find("#txt_name").val("");
                            $layer.find("#txt_showindex").val(1);
                            $layer.find("#txt_url").val("");
            ...
            $('#dg').datagrid({
                ...
                url: '/admin/m_NvaBarManager.aspx',
                type: "POST",
        ...
        function edit(index) {
            var _layerIndex = $.layer({
                ...
                success: function ($layer) {
                    ...
                    $layer.find("#txt_url").val(row.Url);
                    $layer.on("click", ".btn_ok", function () {
                        var b = $('#form1').validationEngine('validate');//手动验证
                        if (!b) {
                            return;
        ...
        <div class="Hide_EditArticleType hide_box">
            <div>
                <ul>
                    ...
                    <li><span>URL：</span>
                        <input type="text" class="validate[required]" id="txt_url" maxlength="30" />
                    </li>
                    <li>
                        <span>排序：</span>
