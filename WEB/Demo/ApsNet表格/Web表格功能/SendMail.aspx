<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMail.aspx.cs" Inherits="Web表格功能.SendMail" %>
        ...
        <div class="t_main">
            ...
            <table class="m-table">
                <asp:Repeater ID="rpt_user" runat="server">
                    ...
                    <ItemTemplate>
                        <tr class="j-item" id='tr<%#Eval("UserID")%>'>
                            <td>
                                <%#Eval("UserID")%>
                            </td>
                            <td>
                            ...
                            <td style="cursor: pointer;" class="check-item">
                                <input id="txtID" type="hidden" name="txtID" value='<%#Eval("UserID")%>' runat="server">
                    ...
                    <AlternatingItemTemplate>
                        <tr class="j-item" id='tr<%#Eval("UserID")%>'>
                            ...
                            <td style="cursor: pointer;" class="check-item">
                                <input id="txtID1" type="hidden" name="txtID" value='<%#Eval("UserID")%>' runat="server">
            ...
            <webdiyer:AspNetPager CssClass="paginator" CurrentPageButtonClass="cpb" ID="pager"
                OnPageChanged="pager_PageChanged" runat="server" FirstPageText="首页" LastPageText="尾页"
